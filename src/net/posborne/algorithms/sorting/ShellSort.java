...
public class ShellSort {
     ...
     * the array. We start with and nx1 array that is completely unsorted and then
     * sort those.  Then we combine and sort some more, getting to the point where
     * we have only one column.  This plays on the strength of the underlying
     * selection sort of performing less swaps for smaller data lists.
     * 
     * @param <T>
